...
cia = ["cia.gov"]
gov = ["usaid.gov", "voanews.com", "alhuraa.com", "rfa.org", "rferl.org", "radiotelevisionmarti.com", "radiofarda.com", "state.gov", "president.gov", "usgs.gov"]
result = dict()
